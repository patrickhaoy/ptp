            ...
            if self._goal_is_encoded:
                ...
                if isinstance(self._obs_encoder, VqvaeVariationalObsEncoder):
                    assert (
                        ...
                        goal.shape[-1] == self._obs_encoder._vqvae.representation_size)  
                else:
...
class EncodingGaussianPolicyV2(TorchStochasticPolicy):
    ...
    def __init__(
        ...
        #     # obs_encoder_kwargs['output_dim'] = self._goal_encoder.output_dim  
            ...
            if self._goal_is_encoded:
                ...
                if isinstance(self._goal_encoder, VqvaeVariationalObsEncoder):
                    assert (
                        ...
                        goal.shape[-1] == self._goal_encoder._vqvae.representation_size)  
                else:
